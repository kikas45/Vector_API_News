...
class NotificationService : Service() {
    ...
    private val thirtyMinutesInMillis = 30 * 60 * 1000 // to fetch news after 30 minutes from now
    private val handleTimeIn25Minutes = 27 * 60 * 1000 // to check for news in 25 minutes time from starts
    private val deleteNotification = 25 * 60 * 1000 // to fetch news after 30 minutes from now
